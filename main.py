...
if __name__ == "__main__":
	...
	if FIELD_MODE['SUNFLOWER_SPAMMING_MODE'] == True:
		my_init_fields.init_field_with_sunflower(WORLD_SIZE)
		my_automated_fields.automated_field_with_sunflower(WORLD_SIZE)
